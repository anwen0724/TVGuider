...
def build_root_cause_prompt(llm_context: dict, *, language: str = "en") -> str:
    ...
    if lang.startswith("zh"):
        instructions = (
            ...
            "- tvir_features：客观证据（path_metrics/fanout/hierarchy）\n"
        ...
        instructions = (
            ...
            "- tvir_features (objective evidence: path_metrics/fanout/hierarchy)\n"
            ...
            "Your tasks:\n"
            "1) Decide the final root-cause labels (final_root_cause) based primarily on evidence/features;\n"
