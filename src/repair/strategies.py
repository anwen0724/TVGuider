...
_add_strategy(
    RepairStrategy(
        ...
        preconditions=["latency_increase_allowed", "path_has_heavy_arith_or_logic"],
        timing_gain="high",
        risk_level="medium",
...
_add_strategy(
    RepairStrategy(
        ...
        preconditions=["has_high_fanout_signal", "latency_increase_allowed"],
        timing_gain="medium",
        risk_level="low",
        change_scope="local",
...
_add_strategy(
    RepairStrategy(
        ...
        preconditions=["latency_increase_allowed", "path_is_single_module"],
        timing_gain="high",
        risk_level="medium",
        change_scope="single_module",
        notes=[
...
_add_strategy(
    RepairStrategy(
        ...
        preconditions=["can_refactor_expression", "latency_increase_allowed"],
        timing_gain="medium",
        risk_level="low",
        change_scope="single_module",
        notes=[
...
_add_strategy(
    RepairStrategy(
        ...
        preconditions=["latency_increase_allowed"],
        timing_gain="high",
        risk_level="medium",
